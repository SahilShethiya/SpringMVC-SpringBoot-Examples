...
public class myclass2 {
		public void insert(myclass1 obj)
		{
			...
			Connection c=DriverManager.getConnection("jdbc:mysql://localhost/demo_login","root","root");
			Statement s=c.createStatement();
			int r=s.executeUpdate("Insert into userreg VALUES('"+obj.getId()+"','"+obj.getFn()+"','"+obj.getLn()+"')");
			if(r!=0)
			{
		...
		public void delete(myclass1 obj)
		{
			try
			{
				...
				Connection c=DriverManager.getConnection("jdbc:mysql://localhost/demo_login","root","root");
				Statement s=c.createStatement();
				int rs=s.executeUpdate("Delete from userreg where id='"+obj.getId()+"'");
				if(rs!=0)
				{
